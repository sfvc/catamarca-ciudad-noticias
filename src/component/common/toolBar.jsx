...
import AccessBtnMobile from './accessModalMobile';
...
const ToolBar = () => {
  ...
  const sideAnimationOut = () => sideAnimation(50);
  ...
  return (
    <>
      ...
      <AccessBtnMobile isMenuMobileOpen={isMenuMobileOpen} toggleMenu={toggleMobileMenu} closeMenuMobile={closeMenuMobile} />
